...
namespace OnlineLearningResourcesApp.Migrations
{
    ...
    [Migration("20151230153218_IdentityEntities")]
    partial class IdentityEntities
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("OnlineLearningResoursesApp.Models.User", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineLearningResoursesApp.Models.User")
                        .WithMany()
